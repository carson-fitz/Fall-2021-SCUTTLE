            ...
            if objects.is_new :
                ...
                if len(obj_array) > 0 :
                    ...
                    position = first_object.position  #*****************************************************
					 		# position [0] = x, postion[2] = y		
                    velocity = first_object.velocity  #****************************************************
							#velocity[0] = x, velocity[2] = y
                    ...
                    plt.scatter(position[0],position[1])  #basic plot of x,y data
                    line, = plt.plot(position[0],position[1]) #basic plot of x,y data
